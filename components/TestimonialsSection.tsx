  ...
  return (
    <section id="testimonials" className="py-20 bg-medical-blue text-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center pt-8 border-t border-white/20">
